        ...
        <View style={styles.slideSelector}>
          {this.state.uberPoolSelect === true && (
            <View style={styles.shareContainer}>
              <Grid>
                <Col style={{...styles.shareOptions, width: width / 1.4}}>
                  <Text style={{color: "#555", fontSize: 15}}>
                    Share your car and save upto<Text style={styles.shareType}>
                      {" "}
                      50%
                    </Text>
                  </Text>
                </Col>
                <Col style={styles.share}>
                  <Text style={{fontSize: 15}}>1-2 people</Text>
                </Col>
              </Grid>
            </View>
          )}
              ...
              <Grid style={{justifyContent: "center"}}>
                <Col style={{...styles.shareOptions, width: width / 1.4}}>
                  <Text style={{color: "#555", fontSize: 14}}>
                    SELECT<Text style={styles.shareType}> TAXIPOOL</Text> NEXT
                  </Text>
                </Col>
                <Col style={styles.share}>
          ...
          <Grid>
            <Col style={styles.taxiTypeContainer}>
              ...
              <Row
                style={
                  this.state.uberPoolSelect === true ? styles.taxiType : {}
                }
              >
                <View
                  style={{
                    ...(this.state.uberPoolSelect === true ? styles.taxi : {}),
                    marginVertical: Platform.OS === "android" ? 6 : undefined
                  }}
                >
                  <Icon
                    name={
                      this.state.uberPoolSelect === false
                    ...
                    onPress={this.uberPool.bind(this)}
                  />
                </View>
              </Row>
            </Col>
            <Col style={styles.taxiTypeContainer}>
              ...
              <Row
                style={this.state.uberGoSelect === true ? styles.taxiType : {}}
              >
                <View
                  style={{
                    ...(this.state.uberGoSelect === true ? styles.taxi : {}),
                    marginVertical: Platform.OS === "android" ? 6 : undefined
                  }}
                >
                  <Icon
                    name={
                      this.state.uberGoSelect === false
                        ? "ios-radio-button-off"
                        : "ios-car"
                    }
                    style={
            ...
            <Col style={styles.taxiTypeContainer}>
              ...
              <Row
                style={this.state.uberXSelect === true ? styles.taxiType : {}}
              >
                <View
                  style={{
                    ...(this.state.uberXSelect === true ? styles.taxi : {}),
                    marginVertical: Platform.OS === "android" ? 6 : undefined
                  }}
                >
                  <Icon
                    name={
                      this.state.uberXSelect === false
                        ? "ios-radio-button-off"
                        : "ios-car"
                    }
                    style={
            ...
            <Col style={styles.taxiTypeContainer}>
              ...
              <Row
                style={this.state.uberXLSelect === true ? styles.taxiType : {}}
              >
                <View
                  style={{
                    ...(this.state.uberXLSelect === true ? styles.taxi : {}),
                    marginVertical: Platform.OS === "android" ? 6 : undefined
                  }}
                >
                  <Icon
                    name={
                      this.state.uberXLSelect === false
                        ? "ios-radio-button-off"
                        : "ios-car"
                    }
                    style={
          ...
          >
            <Grid>
              ...
              >
                ...
                >
                  <Text
                    style={{...styles.SearchPickText, alignSelf: "flex-start"}}
                  >
                    PICKUP LOCATION
                  </Text>
                </Row>
