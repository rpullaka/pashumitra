    ...
    return (
      <View style={{flex: 1}}>
              ...
              <View style={{top: -20}}>
                <Icon
                  ...
                  style={{
                    ...
                    ...{alignSelf: "center", color: "green", flex: 1}
                  }}
                />
              </View>
            </MapView.Marker>
        ...
        <Image
          ...
          style={{
            ...(Platform.OS === "ios" ? {height: height} : {height: height}),
        ...
        <View style={styles.slideSelector}>
          ...
          <Card style={{margin: 0}}>
            <CardItem
              style={{alignSelf: "center", borderBottomWidth: 0, margin: 0}}
            >
              <Left
                style={{
                  alignSelf: "center",
              ...
              >
                <Icon name="md-alarm" />
                <Body>
                  <Text style={{fontWeight: "700"}}>WAIT FOR RIDER</Text>
            ...
            >
              <Button
                block
                onPress={() => Actions.dropOff({type: ActionConst.REPLACE})}
        ...
        >
          <View
            style={{height: height, backgroundColor: commonColor.brandPrimary}}
          >
            <Header
            ...
            <Content style={styles.modalContainer}>
                ...
                <Card>
                  <CardItem bordered>
                    <Left style={{marginLeft: -10}}>
                      <Body>
                        <Text
                          style={{color: "green", fontSize: 13, lineHeight: 15}}
                        >
                          PICK UP
                        </Text>
                    ...
                    >
                      <Icon
                        name="ios-person"
                        style={{color: commonColor.toolbarDarkBg}}
                      />
                    </Right>
                  </CardItem>
                    ...
                    <Grid>
                      <Col>
                        <CardItem
                          ...
                          style={{
                            ...styles.btnContain,
                            ...{borderRightWidth: 0.5, borderColor: "#ddd"}
                          }}
                        >
                          <Left>
              ...
              <View style={{paddingVertical: 30, paddingHorizontal: 10}}>
                ...
                <Card>
                  <CardItem>
                    <Left>
                      <Icon name="ios-person" style={{alignSelf: "center"}} />
                      <Body>
            ...
            <View style={styles.searchBar}>
              ...
              <View style={styles.place}>
                <Text style={styles.placeText}>
                  4th T Block East, Jayanagara, Bengaluru
                </Text>
              </View>
            </View>
          </View>
