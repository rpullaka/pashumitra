...
import { Content, View, Text, Icon, List, ListItem, Left } from "native-base";
          ...
          <List foregroundColor={"white"} style={styles.profile}>
            ...
            >
              <Left>
                ...
                <Text style={{ ...styles.linkText, marginTop: 2 }}>
                  Shivraj Kumar
                </Text>
              </Left>
            </ListItem>
          ...
          <List foregroundColor={"white"} style={styles.Bg}>
            ...
            >
              <Left>
                ...
                />
                <Text
                  style={{ ...styles.linkText, marginTop: 5, marginLeft: 5 }}
                >
                  {" "}
                  SIGN OUT{" "}
                </Text>
            ...
            >
              <Left>
                ...
                />
                <Text style={styles.linkText}>Driver App</Text>
              </Left>
            </ListItem>
          </List>
        </Content>
