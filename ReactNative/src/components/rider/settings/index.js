                        ...
                        <Grid>
                            <Row style={{ ...styles.inputContainer, ...{flexDirection: "row", margin: 10}}}>
                                <Col style={styles.input}>
                                    ...
                                    <Input value="Geek" placeholderTextColor={commonColor.lightThemePlaceholder} disabled/>
                                    </Item>
                                </Col>
                                <Col style={styles.input}>
                                     <Item stackedLabel style={{borderBottomWidth:1 ,marginHorizontal :10 }}>
                                     <Label note>LAST NAME</Label>
                                    <Input value="Rishabh" placeholderTextColor={commonColor.lightThemePlaceholder} disabled/>
                                    </Item>
                                </Col>
                            </Row>
                            <Row style={{ ...styles.input, ...{marginLeft: 10}}}>
                                ...
                                <Item stackedLabel style={{borderBottomWidth:1 ,marginHorizontal :10}}>
                                    ...
                                    <Input value="geekrishabh@gmail.com" placeholderTextColor={commonColor.lightThemePlaceholder} disabled/>
                                 </Item>
                                 </Col>
                                </Row>
                                ...
                                <Col><Item stackedLabel style={{borderBottomWidth:1 ,marginHorizontal :10}}>
                                   <Label note >MOBILE</Label>
                                    <Input value="9876543210" placeholderTextColor={commonColor.lightThemePlaceholder} disabled/>
                                    </Item></Col>
                                </Row>
