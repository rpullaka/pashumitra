      ...
      <View style={{flex: 1}}>
        ...
        <View style={styles.slideSelector}>
              ...
              <Grid style={{flexDirection: "row", borderWidth: 0}}>
                <Col style={styles.driverInfoContainer}>
                  <Thumbnail
                    square
                    size={60}
                    source={require("../../../../assets/images/Contacts/avatar-9.jpg")}
          ...
          <View style={{flexDirection: "row", height: 40}}>
            <Button bordered style={styles.card} textStyle={styles.btnText}>
              ...
              />
              <Text style={{fontSize: 13, paddingHorizontal: 25}}>
                {" "}
                CONTACT{" "}
              </Text>
            </Button>
        ...
        <View style={styles.headerContainer}>
          ...
          >
            ...
            <Body>
              <Title style={{color: commonColor.brandPrimary}}>En Route</Title>
            </Body>
            <Right />
          </Header>
